...
The main complication in the implementation of consumers in this group is the
...
number of small files. Deciding when to upload a local file to [S3] is a matter
of *upload policy*. We envision two types of policy rules, time-based and
size-based:
