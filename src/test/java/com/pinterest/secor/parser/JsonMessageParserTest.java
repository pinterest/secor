...
public class JsonMessageParserTest extends TestCase {
    ...
    public void testExtractTimestampMillis() throws Exception {
        ...
        // Return 0 if there's no mTimestamp, for any reason.
    ...
    public void testExtractTimestampMillisException1() throws Exception {
        ...
        byte emptyBytes1[] = {};
        jsonMessageParser.extractTimestampMillis(new Message("test", 0, 0, null, emptyBytes1, mTimestamp));
    }
    ...
    public void testExtractTimestampMillisException2() throws Exception {
        ...
        jsonMessageParser.extractTimestampMillis(new Message("test", 0, 0, null, emptyBytes2, mTimestamp));
    }
