...
public class JsonMessageParserTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        byte messageWithSecondsTimestamp[] =
                ("{\"timestamp\":\"1405911096\",\"id\":0,\"guid\":\"0436b17b-e78a-4e82-accf-743bf1f0b884\"," +
        ...
        byte messageWithMillisTimestamp[] =
                ("{\"timestamp\":\"1405911096123\",\"id\":0,\"guid\":\"0436b17b-e78a-4e82-accf-743bf1f0b884\"," +
                         "\"isActive\":false,\"balance\":\"$3,561.87\",\"picture\":\"http://placehold.it/32x32\"," +
                         "\"age\":23,\"eyeColor\":\"green\",\"name\":\"Mercedes Brewer\",\"gender\":\"female\"," +
                         "\"company\":\"MALATHION\",\"email\":\"mercedesbrewer@malathion.com\",\"phone\":\"+1 (848) " +
                         "471-3000\",\"address\":\"786 Gilmore Court, Brule, Maryland, 3200\",\"about\":\"Quis " +
        ...
        byte messageWithMillisFloatTimestamp[] =
                ("{\"timestamp\":\"1405911096123.0\",\"id\":0,\"guid\":\"0436b17b-e78a-4e82-accf-743bf1f0b884\"," +
                         "\"isActive\":false,\"balance\":\"$3,561.87\",\"picture\":\"http://placehold.it/32x32\"," +
                         "\"age\":23,\"eyeColor\":\"green\",\"name\":\"Mercedes Brewer\",\"gender\":\"female\"," +
                         "\"company\":\"MALATHION\",\"email\":\"mercedesbrewer@malathion.com\",\"phone\":\"+1 (848) " +
                         "471-3000\",\"address\":\"786 Gilmore Court, Brule, Maryland, 3200\",\"about\":\"Quis " +
        ...
        byte messageWithNestedTimestamp[] = ("{\"meta_data\":{\"created\":\"1405911096123\"},\"id\":0," +
                                                     "\"guid\":\"0436b17b-e78a-4e82-accf-743bf1f0b884\"," +
                                                     "\"isActive\":false,\"balance\":\"$3,561" +
                                                     ...
                                                     " 471-3000\"," +
                                                     "\"address\":\"786 Gilmore Court, Brule, Maryland, 3200\"," +
                                                     "\"about\":\"Quis nostrud Lorem " +
                                                     "deserunt esse ut reprehenderit aliqua nisi et sunt mollit est. " +
                                                     "Cupidatat incididunt minim " +
                                                     "anim eiusmod culpa elit est dolor ullamco. Aliqua cillum " +
                                                     "eiusmod ullamco nostrud Lorem sit " +
                                                     "amet Lorem aliquip esse esse velit.\\r\\n\"," +
                                                     "\"registered\":\"2014-01-14T13:07:28 +08:00\"," +
                                                     "\"latitude\":47.672012,\"longitude\":102.788623," +
                                                     "\"tags\":[\"amet\",\"amet\",\"dolore\"," +
                                                     "\"eu\",\"qui\",\"fugiat\",\"laborum\"],\"friends\":[{\"id\":0," +
                                                     "\"name\":\"Rebecca Hardy\"}," +
                                                     "{\"id\":1,\"name\":\"Sutton Briggs\"},{\"id\":2,\"name\":\"Dena" +
                                                     " Campos\"}]," +
                                                     "\"greeting\":\"Hello, Mercedes Brewer! You have 7 unread " +
                                                     "messages.\"," + "\"favoriteFruit\":\"strawberry\"}").getBytes(
                "UTF-8");
    ...
    public void testHourlyGetFinalizedUptoPartitions() throws Exception {
        ...
        String[][] expectedPartitions =
                new String[][]{new String[]{"dt=2014-07-21", "hr=00"},
                               new String[]{"dt=2014-07-20"},
                               // there is day partition for previous day
                               ...
                               // there is day partition for 2nd last day
    ...
    public void testMinutelyGetFinalizedUptoPartitions() throws Exception {
        ...
        String[][] expectedPartitions = new String[][]{new String[]{"dt=2014-07-20", "hr=00"},
