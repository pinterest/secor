...
public class RegexMessageParserTest extends TestCase {
    ...
    public void setUp() throws Exception {
      ...
      mMessageWithWrongFormatTimestamp = new Message("test", 0, 0, null, messageWithWrongFormatTimestamp, mTimestamp);
    ...
    public void testExtractTimestampMillisEmpty() throws Exception {
        ...
        regexMessageParser.extractTimestampMillis(new Message("test", 0, 0, null, emptyBytes2, mTimestamp));
    }
