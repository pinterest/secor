...
public class SplitByFieldMessageParserTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        byte messageWithTypeAndTimestamp[] = ("{\"type\":\"event1\",\"timestamp\":\"1405911096000\",\"id\":0," +
                                                      ...
                                                      "\"company\":\"MALATHION\"," +
                                                      "\"email\":\"mercedesbrewer@malathion.com\",\"phone\":\"+1 " +
                                                      "(848) 471-3000\"," +
        ...
        byte messageWithoutTimestamp[] =
                ("{\"type\":\"event2\",\"id\":0,\"guid\":\"0436b17b-e78a-4e82-accf-743bf1f0b884\",\"isActive\":false," +
                         "\"balance\":\"$3,561.87\",\"picture\":\"http://placehold.it/32x32\",\"age\":23," +
                         "\"eyeColor\":\"green\",\"name\":\"Mercedes Brewer\",\"gender\":\"female\"," +
    ...
    public void testExtractTypeAndTimestamp() throws Exception {
        ...
        assertEquals(1405911096000L, jsonMessageParser.extractTimestampMillis(
                (JSONObject) JSONValue.parse(mMessageWithTypeAndTimestamp.getPayload())));
        assertEquals(1405911096123L, jsonMessageParser.extractTimestampMillis(
                (JSONObject) JSONValue.parse(mMessageWithoutType.getPayload())));

        assertEquals("event1", jsonMessageParser.extractEventType(
                (JSONObject) JSONValue.parse(mMessageWithTypeAndTimestamp.getPayload())));
        assertEquals("event2", jsonMessageParser.extractEventType(
                (JSONObject) JSONValue.parse(mMessageWithoutTimestamp.getPayload())));
    }
