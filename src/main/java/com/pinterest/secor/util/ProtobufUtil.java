...
/**
 * Various utilities for working with protocol buffer encoded messages. This utility will look for protobuf class in the
 * configuration. It can be either per Kafka topic configuration, for example:
 *
...
public class ProtobufUtil {
     ...
     * @throws RuntimeException when configuration option
    ...
    public Message decodeJsonMessage(String topic, byte[] payload) throws InvalidProtocolBufferException {
        try {
            Method builderGetter = allTopics
                                   ? messageClassForAll.getDeclaredMethod("newBuilder")
                                   : messageClassByTopic.get(topic).getDeclaredMethod("newBuilder");
            com.google.protobuf.GeneratedMessageV3.Builder builder =
                    (com.google.protobuf.GeneratedMessageV3.Builder) builderGetter.invoke(null);
     ...
     * @param payload Byte array containing encoded protobuf
     * @return protobuf message instance
     * @throws RuntimeException when there's problem decoding protobuf
     */
    public Message decodeProtobufMessage(String topic, byte[] payload) {
        ...
        try {
            ...
            throw new RuntimeException("Can't parse protobuf message, since parseMethod() is not callable. " +
                                               "Please check your protobuf version (this code works with protobuf >= " +
                                               "2.6.1)", e);
    ...
    /**
     * Decodes protobuf message If the secor.topic.message.format property is set to "JSON" for "topic" assume "payload"
     * is JSON
     *
     * @param topic   Kafka topic name
     * @param payload Byte array containing encoded protobuf or JSON message
     * @return protobuf message instance
     * @throws RuntimeException when there's problem decoding protobuf or JSON message
     */
