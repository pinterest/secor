...
public abstract class TimestampedMessageParser extends MessageParser {
    ...
    public TimestampedMessageParser(SecorConfig config) {
        super(config);
        Object outputPatternObj = mConfig.getOutputPattern();
        if (outputPatternObj != null) {
            outputPattern = outputPatternObj.toString();
        }
        ...
        if (outputPattern == null) {
            ...
            mFormatter = new SimpleDateFormat(outputPattern);
        }
    }
