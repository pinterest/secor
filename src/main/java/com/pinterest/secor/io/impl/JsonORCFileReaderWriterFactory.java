...
public class JsonORCFileReaderWriterFactory implements FileReaderWriterFactory {
    ...
    private CompressionKind resolveCompression(CompressionCodec codec) {
        ...
        // although GZip and ZLIB are not same thing there is no better named codec for this case, use hadoop Gzip
        // codec to enable ORC ZLIB compression
    ...
    protected class JsonORCFileReader implements FileReader {
        ...
        public JsonORCFileReader(LogFilePath logFilePath, CompressionCodec codec) throws IOException {
    ...
    protected class JsonORCFileWriter implements FileWriter {
        ...
        public JsonORCFileWriter(LogFilePath logFilePath, CompressionCodec codec) throws IOException {
            ...
            for (int c = 0; c < converters.length; ++c) {
                converters[c] = VectorColumnFiller.createConverter(fieldTypes.get(c));
            }
        ...
        public void write(KeyValue keyValue) throws IOException {
            ...
            VectorColumnFiller.fillRow(rowIndex, converters, schema, batch,
                                       gson.fromJson(new String(keyValue.getValue()), JsonObject.class));
