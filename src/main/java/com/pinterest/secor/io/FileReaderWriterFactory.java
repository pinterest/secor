...
/**
 * Provides a single factory class to make FileReader and FileWriter instances that can read from and write to the same
 * type of output file.
 * <p>
 * Implementers of this interface should provide a zero-argument constructor so that they can be constructed generically
 * when referenced in configuration; see ReflectionUtil for details.
 *
...
public interface FileReaderWriterFactory {
     ...
     * @param codec       the compression codec the file was written with (use null for no codec, or to auto-detect from
     *                    file headers where supported)
