...
/**
 * Parsed message is a Kafka message that has been processed by the parser that extracted its partitions.
 *
...
public class ParsedMessage extends Message {
    ...
    public String toString() {
        return "ParsedMessage{" + fieldsToString(false) + ", mPartitions=" + Arrays.toString(mPartitions) + '}';
    }

    public String toTruncatedString() {
        return "ParsedMessage{" + fieldsToString(true) + ", mPartitions=" + Arrays.toString(mPartitions) + '}';
    }
